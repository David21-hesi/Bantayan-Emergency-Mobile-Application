...
namespace BantayanEmergencyApp
{
    ...
    public partial class LGUEditPage : ContentPage
    {
        ...
        public LGUEditPage(EmergencyReport report)
        {
            InitializeComponent();
        ...
        private async void SaveReport_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                await Navigation.PushModalAsync(new LGUReportsPage(_reportToEdit.Email));
